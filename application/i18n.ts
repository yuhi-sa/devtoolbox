...
export const toolTranslations: Record<string, { name: string; description: string }> = {
  ...
  'hex-encoder': { name: 'Hex Encoder/Decoder', description: 'Encode and decode hexadecimal strings.' },
  rot13: { name: 'ROT13 Cipher', description: 'Apply ROT13 transformation to text.' },
  'morse-code': { name: 'Morse Code', description: 'Convert text to Morse code and back.' },
  'toml-converter': { name: 'TOML Converter', description: 'Convert between TOML and JSON formats.' },
  'number-formatter': { name: 'Number Formatter', description: 'Format numbers with separators, currency, and notation.' },
  'css-unit-converter': { name: 'CSS Unit Converter', description: 'Convert between px, rem, em, vw, and vh.' },
  'xml-json': { name: 'XML/JSON Converter', description: 'Convert between XML and JSON formats.' },
  'markdown-html': { name: 'Markdown to HTML', description: 'Convert Markdown to HTML with preview.' },
  'js-formatter': { name: 'JS Formatter', description: 'Format and minify JavaScript/TypeScript code.' },
  'xml-formatter': { name: 'XML Formatter', description: 'Format, minify, and validate XML.' },
  'slug-generator': { name: 'Slug Generator', description: 'Generate URL-friendly slugs from text.' },
  'data-url': { name: 'Data URL Generator', description: 'Generate data URLs from text or SVG.' },
  'box-shadow': { name: 'Box Shadow Generator', description: 'Generate CSS box-shadow with visual editor.' },
  'border-radius': { name: 'Border Radius Generator', description: 'Generate CSS border-radius with visual editor.' },
  'flexbox-generator': { name: 'Flexbox Playground', description: 'Build CSS Flexbox layouts visually.' },
  'grid-generator': { name: 'Grid Generator', description: 'Build CSS Grid layouts visually.' },
  'text-counter': { name: 'Text Counter', description: 'Count characters, words, sentences, and reading time.' },
  'json-size': { name: 'JSON Size Analyzer', description: 'Analyze JSON structure, size, and depth.' },
  'date-calculator': { name: 'Date Calculator', description: 'Calculate date differences and add/subtract days.' },
  'aspect-ratio': { name: 'Aspect Ratio Calculator', description: 'Calculate and convert aspect ratios.' },
  'color-contrast': { name: 'Color Contrast Checker', description: 'Check WCAG color contrast ratios (AA/AAA).' },
  'emoji-picker': { name: 'Emoji Picker', description: 'Search and copy emojis with Unicode info.' },
  'json-validator': { name: 'JSON Validator', description: 'Validate JSON with detailed error positions.' },
  'semver-tester': { name: 'Semver Tester', description: 'Parse, compare, and test semantic versions.' },
  'html-colors': { name: 'HTML Colors Reference', description: 'Browse all 148 CSS named colors.' },
  'mime-types': { name: 'MIME Types Reference', description: 'Search MIME types by file extension.' },
  'keyboard-codes': { name: 'Keyboard Codes', description: 'View keyboard event codes by pressing keys.' },
  'css-specificity': { name: 'CSS Specificity Calculator', description: 'Calculate and compare CSS selector specificity.' },
  'email-validator': { name: 'Email Validator', description: 'Validate email addresses with RFC checks.' },
  'htaccess-generator': { name: '.htaccess Generator', description: 'Generate Apache .htaccess configuration.' },
  editorconfig: { name: 'EditorConfig Generator', description: 'Generate .editorconfig files for your project.' },
  tsconfig: { name: 'tsconfig.json Generator', description: 'Generate TypeScript configuration files.' },
  nanoid: { name: 'NanoID Generator', description: 'Generate random IDs in various formats.' },
  punycode: { name: 'Punycode Converter', description: 'Encode/decode international domain names (IDN).' },
  'sql-generator': { name: 'SQL Generator', description: 'Generate CREATE TABLE, INSERT, and ALTER statements.' },
  'eslint-config': { name: 'ESLint Config Generator', description: 'Generate ESLint flat config files.' },
  'text-diff-inline': { name: 'Inline Diff', description: 'Show character-level inline text differences.' },
  'json-to-go': { name: 'JSON to Go Struct', description: 'Generate Go struct definitions from JSON.' },
  'json-to-python': { name: 'JSON to Python Dataclass', description: 'Generate Python dataclass definitions from JSON.' },
  base58: { name: 'Base58 Encoder/Decoder', description: 'Encode/decode Base58 (Bitcoin format).' },
};

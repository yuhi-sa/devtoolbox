...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Split text into words, handling camelCase, PascalCase, snake_case, kebab-case, spaces
    function splitWords(text) {
      // Replace underscores and hyphens with spaces
      var normalized = text.replace(/[_\-]/g, " ");
      // Insert space before uppercase letters in camelCase/PascalCase
      normalized = normalized.replace(/([a-z])([A-Z])/g, "$1 $2");
      // Insert space between consecutive uppercase followed by lowercase (e.g., HTMLParser -> HTML Parser)

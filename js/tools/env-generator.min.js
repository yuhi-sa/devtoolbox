...
if(isComment){
row.innerHTML='<div style="display:flex;gap:.5rem;align-items:center;">'+'<span style="color:var(--color-text-muted);font-weight:bold;">#</span>'+'<input type="text" class="input" data-field="comment" value="'+escapeAttr(key)+'" placeholder="コメント" style="flex:1;">'+'<button type="button" class="btn btn--secondary" data-remove="'+id+'" style="padding:.25rem .5rem;font-size:.85rem;">削除</button>'+'</div>';
}else{
row.innerHTML='<div style="display:flex;flex-wrap:wrap;gap:.5rem;align-items:center;">'+'<input type="text" class="input" data-field="key" value="'+escapeAttr(key||"")+'" placeholder="KEY" style="flex:2;min-width:120px;">'+'<input type="text" class="input" data-field="value" value="'+escapeAttr(value||"")+'" placeholder="value" style="flex:3;min-width:160px;">'+'<select class="input" data-field="type" style="width:auto;min-width:100px;">'+'<option value="string"'+(typeVal==="string"?" selected":"")+'>文字列</option>'+'<option value="number"'+(typeVal==="number"?" selected":"")+'>数値</option>'+'<option value="boolean"'+(typeVal==="boolean"?" selected":"")+'>真偽値</option>'+'<option value="secret"'+(typeVal==="secret"?" selected":"")+'>シークレット</option>'+'</select>'+'<button type="button" class="btn btn--secondary" data-secret="'+id+'" style="padding:.25rem .5rem;font-size:.85rem;">生成</button>'+'<button type="button" class="btn btn--secondary" data-remove="'+id+'" style="padding:.25rem .5rem;font-size:.85rem;">削除</button>'+'</div>';
}

      ...
      for (var li = 0; li < lines.length; li++) {
        ...
        if (stripped.charAt(0) === "[") {
          if (stripped.charAt(1) === "[") {
            ...
            // Navigate and create array of tables
            var target = result;
            ...
            // Navigate to the table, creating objects as needed
            currentTable = result;
    ...
    function parseValue(str, lineNum) {
      ...
      if (ch === '"') {
        if (val.substring(0, 3) === '"""') {
          // Multi-line basic string - find closing """
      ...
      // Remove trailing comment for number parsing
      var numStr = val;
      ...
      // Try integer (may have underscores)
    ...
    function jsonToToml(data, prefix) {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        if (val === null || val === undefined) {
          ...
          // Check if it has nested tables or is a simple object
          if (hasNestedObjects(val)) {
            ...
            // Simple object - could be inline table or table section
